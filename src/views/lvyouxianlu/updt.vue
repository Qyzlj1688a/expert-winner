      ...
      <div class="form-database-form">
        ...
        <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
          <el-form-item label="线路编号" prop="xianlubianhao" :rules="[{required:true, message:'请填写线路编号'}]">
            <el-input placeholder="输入线路编号" style="width:250px;" v-model="form.xianlubianhao"/>
          </el-form-item>
          ...
          <el-form-item label="出发地" prop="chufadi">
            <el-input placeholder="输入出发地" style="width:450px;" v-model="form.chufadi"/>
          </el-form-item>

          <el-form-item label="途经地" prop="tujingdi">
            <el-input placeholder="输入途经地" style="width:450px;" v-model="form.tujingdi"/>
          </el-form-item>
          ...
          <el-form-item label="价格" prop="jiage" required
            ...
            <el-input placeholder="输入价格" style="width:250px;" v-model="form.jiage"/>
          </el-form-item>

          <el-form-item label="线路特色" prop="xianlutese">
            <e-editor v-model="form.xianlutese"></e-editor>
          </el-form-item>

          <el-form-item label="线路简介" prop="xianlujianjie">
            <e-editor v-model="form.xianlujianjie"></e-editor>
          </el-form-item>
