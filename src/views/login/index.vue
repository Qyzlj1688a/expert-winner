      ...
      <el-row type="flex" align="center" justify="center" class="h-100vh" style="align-items: center">
        ...
        <el-col :md="8" :offset="1">
          <div class="d-flex align-items-center" style="margin-bottom: 20px">
            ...
            <h3 class="m-0" style="margin: 0;color: #f15323">{{ setting.title }}</h3>
          </div>
          <form action="javascript:;" id="loginForm" name="loginForm" method="post" @submit="login">
            ...
            <div class="form-group mb-4">
              ...
              <el-input type="text" v-model="form.pagerandom" name="pagerandom" class="form-control form-control-lg"
                        id="pagerandom" placeholder="验证码">
                                <span class="input-group-append" slot="append">
                                    <e-img :src="captchUrl" style="min-width: 60px;min-height: 30px;"
            ...
            <el-button type="primary" native-type="submit" class="btn btn-primary btn-lg btn-block btn-uppercase mb-4">
              登录系统
            </el-button>
