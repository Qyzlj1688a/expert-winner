    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="分类" width="80">
          <template slot-scope="{row}">
            <e-select-view module="xinwenfenlei" :value="row.fenlei" select="id" show="fenleimingcheng"></e-select-view>
          </template>
        </el-table-column>
          ...
          <template slot-scope="{row}">
            <el-button-group>
              ...
              <el-tooltip content="详情" placement="top">
                <el-button @click="$goto({path:'/admin/xinwenxinxidetail',query:{id:row.id } })" icon="el-icon-info"
