        ...
        <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
          ...
          <el-form-item label="分类" prop="fenlei" required :rules="[{required:true, message:'请填写分类'}]">
            <el-select v-model="form.fenlei">
              <el-option :key="key" v-for="m in xinwenfenleiList" :value="m.id" :label="m.fenleimingcheng"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="点击率" prop="dianjilv"
                        :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
            <el-input placeholder="输入点击率" style="width:250px;" v-model="form.dianjilv"/>
          </el-form-item>
