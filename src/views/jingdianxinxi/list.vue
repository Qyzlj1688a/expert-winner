    ...
    <el-card class="box-card">
      ...
      <div class="form-search">
        <el-form @submit.prevent.stop :inline="true" size="mini">
          ...
          <el-form-item label="所属地区">
            ...
            <el-select v-model="search.suoshudiqu">
      ...
      >
        ...
        <el-table-column label="景点名称">
          <template slot-scope="{row}">
            {{ row.jingdianmingcheng }}
          </template>
        </el-table-column>
        <el-table-column label="所属地区" width="80">
          <template slot-scope="{row}">
            <e-select-view module="diqu" :value="row.suoshudiqu" select="id" show="diqumingcheng"></e-select-view>
          </template>
        </el-table-column>
          ...
          <template slot-scope="{row}">
            <el-button-group>
              ...
              <el-tooltip content="详情" placement="top">
                <el-button @click="$goto({path:'/admin/jingdianxinxidetail',query:{id:row.id } })" icon="el-icon-info"
                           type="info" size="mini"></el-button>
              </el-tooltip>
