    ...
    <el-card class="box-card">
      ...
      <div class="form-database-form">
        ...
        <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
          ...
          <el-form-item label="所属地区" prop="suoshudiqu" required
                        :rules="[{required:true, message:'请填写所属地区'}]">
          ...
          <el-form-item label="开放时间" prop="kaifangshijian" required
                        :rules="[{required:true, message:'请填写开放时间'}]">
            <el-input placeholder="输入开放时间" style="width:450px;" v-model="form.kaifangshijian"/>
          </el-form-item>
          ...
          <el-form-item label="地址" prop="dizhi" required :rules="[{required:true, message:'请填写地址'}]">
            <el-input placeholder="输入地址" style="width:450px;" v-model="form.dizhi"/>
          </el-form-item>

          <el-form-item label="票价" prop="piaojia" :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
            <el-input placeholder="输入票价" style="width:250px;" v-model="form.piaojia"/>
          </el-form-item>

          <el-form-item label="描述" prop="miaoshu" required :rules="[{required:true, message:'请填写描述'}]">
            <e-editor v-model="form.miaoshu"></e-editor>
          </el-form-item>
