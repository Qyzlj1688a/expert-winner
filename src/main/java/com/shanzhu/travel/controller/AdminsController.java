...
public class AdminsController extends BaseController {
    ...
    public String list() {
        ...
        List<Admins> list = adminsService.selectPageExample(example, page, pagesize);   // 获取当前页的行数
    ...
    public String updt() {
        ...
        // 获取行数据，并赋值给前台jsp页面
        Admins mmm = adminsService.find(id);
        assign("mmm", mmm);
        assign("updtself", 0);
        return json();   // 将数据写给前端
    }
    ...
    public String insert() {
        ...
        adminsService.insert(post); // 插入数据
    ...
    public String update() {
        ...
        adminsService.update(post); // 更新数据
    ...
    public String delete() {
        ...
        adminsService.delete(id);// 根据id 删除某行数据
