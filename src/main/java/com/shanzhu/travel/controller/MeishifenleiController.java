...
public class MeishifenleiController extends BaseController {
    ...
    public String list() {
        ...
        List<Meishifenlei> list = meishifenleiService.selectPageExample(example, page, pagesize);   // 获取当前页的行数
    ...
    public String updt() {
        ...
        // 获取行数据，并赋值给前台jsp页面
        Meishifenlei mmm = meishifenleiService.find(id);
        assign("mmm", mmm);
        assign("updtself", 0);
    ...
    public String insert() {
        ...
        meishifenleiService.insert(post); // 插入数据
    ...
    public String update() {
        ...
        meishifenleiService.update(post); // 更新数据
    ...
    public String delete() {
        ...
        meishifenleiService.delete(id);// 根据id 删除某行数据
