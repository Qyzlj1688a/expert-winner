...
public class XinwenfenleiController extends BaseController {
    ...
    public String list() {
        ...
        List<Xinwenfenlei> list = xinwenfenleiService.selectPageExample(example, page, pagesize);   // 获取当前页的行数
    ...
    public String updt() {
        ...
        // 获取行数据，并赋值给前台jsp页面
        Xinwenfenlei mmm = xinwenfenleiService.find(id);
        assign("mmm", mmm);
        assign("updtself", 0);
    ...
    public String insert() {
        ...
        xinwenfenleiService.insert(post); // 插入数据
    ...
    public String update() {
        ...
        xinwenfenleiService.update(post); // 更新数据
    ...
    public String delete() {
        ...
        xinwenfenleiService.delete(id);// 根据id 删除某行数据
