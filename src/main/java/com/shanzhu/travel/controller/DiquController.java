...
public class DiquController extends BaseController {
    ...
    public String list() {
        ...
        List<Diqu> list = diquService.selectPageExample(example, page, pagesize);   // 获取当前页的行数
        // 将列表写给界面使用
    ...
    public String delete() {
        ...
        diquService.delete(id);// 根据id 删除某行数据
