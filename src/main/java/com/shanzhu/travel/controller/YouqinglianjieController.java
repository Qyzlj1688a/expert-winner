...
public class YouqinglianjieController extends BaseController {
    ...
    public String list() {
        ...
        List<Youqinglianjie> list = youqinglianjieService.selectPageExample(example, page, pagesize);   // 获取当前页的行数
    ...
    public String updt() {
        ...
        // 获取行数据，并赋值给前台jsp页面
        Youqinglianjie mmm = youqinglianjieService.find(id);
        assign("mmm", mmm);
        assign("updtself", 0);
    ...
    public String insert() {
        ...
        youqinglianjieService.insert(post); // 插入数据
    ...
    public String update() {
        ...
        youqinglianjieService.update(post); // 更新数据
    ...
    public String delete() {
        ...
        youqinglianjieService.delete(id);// 根据id 删除某行数据
