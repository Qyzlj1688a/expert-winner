...
public class YudingController extends BaseController {
    ...
    public String list() {
        ...
        List<Yuding> list = yudingService.selectPageExample(example, page, pagesize);   // 获取当前页的行数
    ...
    public String listyudingren() {
        ...
        List<Yuding> list = yudingService.selectPageExample(example, page, pagesize);
        assign("totalCount", request.getAttribute("totalCount"));
        assign("list", list);
    ...
    public String add() {
        ...
        Lvyouxianlu readMap = lvyouxianluService.find(id);
        // 将数据行写入给前台jsp页面
    ...
    public String updt() {
        ...
        // 获取行数据，并赋值给前台jsp页面
        Yuding mmm = yudingService.find(id);
        assign("mmm", mmm);
        assign("updtself", 0);
    ...
    public String insert() {
        ...
        yudingService.insert(post); // 插入数据
    ...
    public String update() {
        ...
        yudingService.update(post); // 更新数据
    ...
    public String delete() {
        ...
        yudingService.delete(id);// 根据id 删除某行数据
